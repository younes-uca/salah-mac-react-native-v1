...
import ma.sir.ecom.ws.converter.ReceptionConverter;
...
public class ReceptionRestAdmin  extends AbstractController<Reception, ReceptionDto, ReceptionHistory, ReceptionCriteria, ReceptionHistoryCriteria, ReceptionAdminService, ReceptionConverter> {
    ...
    public List<Reception> findByOrderId(@PathVariable Long id){
    ...
    @ApiOperation("find by receptionStatus id")
    @GetMapping("receptionStatus/id/{id}")
    public List<Reception> findByReceptionStatusId(@PathVariable Long id){
        return service.findByReceptionStatusId(id);
    }
    @ApiOperation("delete by receptionStatus id")
    @DeleteMapping("receptionStatus/id/{id}")
    public int deleteByReceptionStatusId(@PathVariable Long id){
        return service.deleteByReceptionStatusId(id);
    }

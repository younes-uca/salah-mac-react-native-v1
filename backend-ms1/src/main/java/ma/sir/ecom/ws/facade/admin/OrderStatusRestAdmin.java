...
import ma.sir.ecom.ws.converter.OrderStatusConverter;
...
public class OrderStatusRestAdmin  extends AbstractController<OrderStatus, OrderStatusDto, OrderStatusHistory, OrderStatusCriteria, OrderStatusHistoryCriteria, OrderStatusAdminService, OrderStatusConverter> {
    ...
    @ApiOperation("upload one orderStatus")
    @RequestMapping(value = "upload", method = RequestMethod.POST, consumes = "multipart/form-data")
    public ResponseEntity<FileTempDto> uploadFileAndGetChecksum(@RequestBody MultipartFile file) throws Exception {
        return super.uploadFileAndGetChecksum(file);
    }
    @ApiOperation("upload multiple orderStatuss")
    ...
    @ApiOperation("Finds an optimized list of all orderStatuss")
    ...
    @ApiOperation("Delete list of orderStatus")
    ...
    @ApiOperation("Delete multiple orderStatuss by ids")
    ...
    @ApiOperation("Finds orderStatuss by criteria")
    ...
    @ApiOperation("Finds paginated orderStatuss by criteria")
    ...
    @ApiOperation("Exports orderStatuss by criteria")
    @PostMapping("export")
    public ResponseEntity<InputStreamResource> export(@RequestBody OrderStatusCriteria criteria) throws Exception {
        return super.export(criteria);
    }

    @ApiOperation("Gets orderStatus data size by criteria")
    @PostMapping("data-size-by-criteria")
    public ResponseEntity<Integer> getDataSize(@RequestBody OrderStatusCriteria criteria) throws Exception {
        return super.getDataSize(criteria);
    }

    @ApiOperation("Gets orderStatus history by id")
    @GetMapping("history/id/{id}")
    public ResponseEntity<AuditEntityDto> findHistoryById(@PathVariable("id") Long id) throws Exception {
        return super.findHistoryById(id);
    }

    @ApiOperation("Gets orderStatus paginated history by criteria")
    @PostMapping("history-paginated-by-criteria")
    public ResponseEntity<PaginatedList> findHistoryPaginatedByCriteria(@RequestBody OrderStatusHistoryCriteria criteria) throws Exception {
        return super.findHistoryPaginatedByCriteria(criteria);
    }

    @ApiOperation("Exports orderStatus history by criteria")
    @PostMapping("export-history")
    public ResponseEntity<InputStreamResource> exportHistory(@RequestBody OrderStatusHistoryCriteria criteria) throws Exception {
        return super.exportHistory(criteria);
    }

    @ApiOperation("Gets orderStatus history data size by criteria")
    @PostMapping("history-data-size")
    public ResponseEntity<Integer> getHistoryDataSize(@RequestBody OrderStatusHistoryCriteria criteria) throws Exception {

...
public class AccountingOperationType   extends AuditBusinessObject     {
    ...
    public AccountingOperationType(){
        super();
    }

    public AccountingOperationType(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        AccountingOperationType accountingOperationType = (AccountingOperationType) o;
        return id != null && id.equals(accountingOperationType.id);
    }

...
public class CreditNotePurchaseStatus   extends AuditBusinessObject     {
    ...
    public CreditNotePurchaseStatus(){
        super();
    }

    public CreditNotePurchaseStatus(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        CreditNotePurchaseStatus creditNotePurchaseStatus = (CreditNotePurchaseStatus) o;
        return id != null && id.equals(creditNotePurchaseStatus.id);
    }

...
public class ReturnStatus   extends AuditBusinessObject     {
    ...
    public ReturnStatus(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        ReturnStatus returnStatus = (ReturnStatus) o;
        return id != null && id.equals(returnStatus.id);
    }

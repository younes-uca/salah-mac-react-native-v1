...
public class SubAccountingClass   extends AuditBusinessObject     {
    ...
    public SubAccountingClass(){
        super();
    }

    public SubAccountingClass(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        SubAccountingClass subAccountingClass = (SubAccountingClass) o;
        return id != null && id.equals(subAccountingClass.id);
    }

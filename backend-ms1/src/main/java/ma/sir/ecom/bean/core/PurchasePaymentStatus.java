...
public class PurchasePaymentStatus   extends AuditBusinessObject     {
    ...
    public PurchasePaymentStatus(){
        super();
    }

    public PurchasePaymentStatus(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        PurchasePaymentStatus purchasePaymentStatus = (PurchasePaymentStatus) o;
        return id != null && id.equals(purchasePaymentStatus.id);
    }

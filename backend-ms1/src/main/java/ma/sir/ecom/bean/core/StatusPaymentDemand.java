...
public class StatusPaymentDemand   extends AuditBusinessObject     {
    ...
    public StatusPaymentDemand(){
        super();
    }

    public StatusPaymentDemand(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        StatusPaymentDemand statusPaymentDemand = (StatusPaymentDemand) o;
        return id != null && id.equals(statusPaymentDemand.id);
    }

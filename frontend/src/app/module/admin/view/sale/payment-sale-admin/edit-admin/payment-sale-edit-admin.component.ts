...
@Component({
  selector: 'app-payment-sale-edit-admin',
  templateUrl: './payment-sale-edit-admin.component.html'
})
export class PaymentSaleEditAdminComponent extends AbstractEditController<PaymentSaleDto, PaymentSaleCriteria, PaymentSaleService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.paymentDate = this.paymentSaleService.format(this.item.paymentDate);
    }

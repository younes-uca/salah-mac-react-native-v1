...
@Component({
  selector: 'app-sale-create-admin',
  templateUrl: './sale-create-admin.component.html'
})
export class SaleCreateAdminComponent extends AbstractCreateController<SaleDto, SaleCriteria, SaleService>  implements OnInit {
    ...
    const isPermistted = await this.roleService.isPermitted('SaleStatus', 'add');
    if(isPermistted) {
         this.saleStatus = new SaleStatusDto();

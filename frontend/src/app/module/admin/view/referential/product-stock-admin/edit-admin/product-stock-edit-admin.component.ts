...
@Component({
  selector: 'app-product-stock-edit-admin',
  templateUrl: './product-stock-edit-admin.component.html'
})
export class ProductStockEditAdminComponent extends AbstractEditController<ProductStockDto, ProductStockCriteria, ProductStockService>   implements OnInit {

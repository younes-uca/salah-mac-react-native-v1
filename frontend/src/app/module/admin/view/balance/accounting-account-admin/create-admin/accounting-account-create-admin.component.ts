...
@Component({
  selector: 'app-accounting-account-create-admin',
  templateUrl: './accounting-account-create-admin.component.html'
})
export class AccountingAccountCreateAdminComponent extends AbstractCreateController<AccountingAccountDto, AccountingAccountCriteria, AccountingAccountService>  implements OnInit {
    ...
    const isPermistted = await this.roleService.isPermitted('SubAccountingClass', 'add');
    if(isPermistted) {
         this.subAccountingClass = new SubAccountingClassDto();

...
@Component({
  selector: 'app-demand-payment-edit-admin',
  templateUrl: './demand-payment-edit-admin.component.html'
})
export class DemandPaymentEditAdminComponent extends AbstractEditController<DemandPaymentDto, DemandPaymentCriteria, DemandPaymentService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.paymentDate = this.demandPaymentService.format(this.item.paymentDate);
    }
